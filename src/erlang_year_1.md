...
Отсутствие статической типизации отчасти компенсируется тулом **Dialyzer**. Это статический анализатор кода, который не только проверяет типы, но находит и другие проблемы в коде.
