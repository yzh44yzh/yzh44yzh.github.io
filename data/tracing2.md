...
А чтобы учиться на практике нужна специальаня учебная система, развернутая на сервере и реально работающая, то есть, обслуживающая запросы клиентов. И я сделал такую систему. Давайте рассмотрим ее.
